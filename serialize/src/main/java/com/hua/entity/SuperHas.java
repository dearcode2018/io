 ...
 * @author  qye.zheng
 */
public class SuperHas implements Serializable
{
	...
	public SuperHas()
	{
		 ...
		 */
		System.out.println("SuperHas.SuperHas()");
	}
	 ...
	 * @param name
	 */
	public SuperHas(String id, String name)
	{
		super();
		this.id = id;
		this.name = name;
	...
	{
		SuperHas.description = description;
	}
